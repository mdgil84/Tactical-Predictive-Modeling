...
data = pd.read_excel(r'/Users/********/Desktop/Readiness Data Pool/Stalwart_CLEANED_FORECAST To December V2.xlsm', sheet_name='ERC A FORECAST')

# Load the future exogenous data
future_exog_data = pd.read_excel(r'/Users/*********/Desktop/Readiness Data Pool/Stalwart_CLEANED_FORECAST To December V2.xlsm', sheet_name='Future Exogenus Data')
...
start_forecast_date = '2023-12-06'
end_forecast_date = '2024-01-31'
...
excel_output_path = '/Users/*******/Desktop/Readiness Data Pool/forecasted_data2.xlsx'
